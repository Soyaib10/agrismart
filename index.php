...
<div class="wrapper" >
    <div class="wrapper">
    <header class="jumbotron" style="background-color: #00684A;">
        <div class="container">
          <div class="row row-header">
            <div class="col-12 col-sm-6">
              <h1 class="text-white">AgriSmart</h1>
              <p class="text-white">
      ...
      <div class="container ">
        ...
        <div class="row align-items-center">
          ...
          <div class="col-lg-6">
           ...
           <p class=" ">Farmers can get recommendations for crop and fertilizer and get weather and get the news related to agriculture</p>
