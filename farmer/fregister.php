        ...
        <ul class="navbar-nav navbar-nav-hover align-items-lg-center">
          <li class="nav-item dropdown">
            <a href="../index.php" class="navbar-brand mr-lg-5 text-white">
                               <img src="../assets/img/agrismart.png" />
            </a>
          </li>
        </ul>
...
<form name="insert" action="" method="post">	
    ...
    $("#success").slideUp(500);
			  ...
			  <div class="form-group row">
                <label for="staffid" class="col-md-3 col-form-label text-white" required="true"> Division <strong class="text-default"> *</strong></label>
                <div class="col-md-9">
...
<footer class="footer">
        <div class="container">
                ...
                <div class="offset-sm-2 col-5 ">
                    ...
                    <address>
		              Sutrapur, Dhaka-1100<br>	
                  <br>              
		              <div class="btn-group text-center" role="group">
                    <a role="button" class="btn btn-primary" href="tel:+8801741129026"><i class="fa fa-phone"></i> Call</a>
                    <a role="button" class="btn btn-info" href="tel:+8801741129026"> <i class="fa fa-fax"></i> Fax</a>
                    <a role="button" class="btn btn-success" href="mailto:selim@gmail.com"> <i class="fa fa-envelope-o"></i> Email</a>
                </div>
		           </address>
                </div>				
       ...
       <button target="_blank" href="/" rel="nofollow" class="btn btn-icon-only btn-linkedin rounded-circle" data-toggle="tooltip" data-original-title="Mail Us">
          ...
          <!-- <button target="_blank" href="/" rel="nofollow" class="btn btn-icon-only btn-github rounded-circle" data-toggle="tooltip" data-original-title="Star on Github">
           ...
           <div class="row justify-content-center">             
                     <div class="col-auto">					
                    <p>&copy; Copyright 2024 <strong> AgriSmart </strong>, All Rights Reserved </p>
                </div>
           </div>
        </div>
    </footer>
