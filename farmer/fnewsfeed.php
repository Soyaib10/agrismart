...
<?php require ('fheader.php');  ?>
 ...
 <!-- <script>
  window.addEventListener("load", function() {
    const endpoint = "https://newsapi.org/v2/everything?q=tesla&from=2024-02-16&sortBy=publishedAt&apiKey=d254fb624c5144d8877bde2957e948ac";
...
<script>
  window.addEventListener("load", function() {
    ...
    .then(data => {
      console.log(data);
      // Display data on your webpage
    })
    .catch(error => {
      console.error("There was a problem fetching data from the API:", error);
      // Display error message on your webpage
    });
  });
</script>
...
<div class="container-fluid ">
	...
	error_reporting(E_ERROR | E_PARSE);
	       ...
	       // https://newsapi.org/v2/everything?q=Agriculture&sortBy=popularity&apiKey=d254fb624c5144d8877bde2957e948ac
	
        $url="https://newsapi.org/v2/everything?q=tesla&from=2024-02-16&sortBy=publishedAt&apiKey=d254fb624c5144d8877bde2957e948ac";   //Your API KEY
